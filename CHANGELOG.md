...
## [Unreleased]
### Added
- Added [POST] `/contacts/` endpoint to create a new contact

### Updated
- Updated test suite for the `contacts-controller`, `contacts-service` and `contacts-repository` to account for the new
functionality of being able to create a contact
